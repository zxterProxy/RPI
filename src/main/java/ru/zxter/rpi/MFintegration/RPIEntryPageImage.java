...
public class RPIEntryPageImage extends EntryPage {
    ...
    public RPIEntryPageImage(String tex, String paragraphs) {
        this(tex, 128, 128, paragraphs);
    }

    public RPIEntryPageImage(String tex, int width, int height, String paragraphs) {
    ...
    public void preRender(GuiScreen parent, int x, int y, float f, int posX, int posY, boolean onTick) {
        mc.renderEngine.bindTexture(RPITextureHelper.getResource(image));
