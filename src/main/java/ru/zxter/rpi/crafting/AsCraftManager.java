...
public class AsCraftManager
{
    /** The static instance of this class */
    private static final AsCraftManager instance = new AsCraftManager();
     ...
     */
    public static final AsCraftManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private AsCraftManager()
    {
       recipes = new ArrayList();
        this.addRecipe(new ItemStack(ItemReg.scroll, 1),new Object[]{"S","S","S","S","S",'S', Items.iron_ingot});


        Collections.sort(this.recipes, new AsCraftRecipesSorter(this));
    }

    public AcShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        AcShapedRecipes shapedrecipes = new AcShapedRecipes(j, k, aitemstack, p_92103_1_);
    ...
    public void addShapelessRecipe(ItemStack p_77596_1_, Object ... p_77596_2_)
    {
        ...
        this.recipes.add(new AcShapelessRecipes(p_77596_1_, arraylist));
    }
