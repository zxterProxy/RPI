...
public class EliteKnigArmor extends ItemArmor {
    ...
    public EliteKnigArmor(ArmorMaterial armorMaterial, int renderIndex, int i, String name, String texture) {
    ...
    public void setTextureName() {
        if (armorType == 0 || armorType == 1 || armorType == 3) {
            this.texturePath += "EliteKnig_" + 1 + ".png";
        } else {
            this.texturePath += "EliteKnig_" + 2 + ".png";
        }
    }
